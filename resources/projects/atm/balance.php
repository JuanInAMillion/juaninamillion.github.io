...
//    $Balance = 999.99;
    ...
    if ($Balance < 0)
   {
            ...
            echo('<script>document.location.href="berror.php"</script>');
     }
...
<div id="atm">
	<div id="atmbody">
    <div id="screen">
    	<p id= "top" align="center"> Your Current Balance: <?php echo $Balance; ?></p>
       
       <div id="twoButtons" class="balPage">
           
            <form name="main" method="post" action="pinnumber.php">
              <input type="submit" class="backbuttonbal" />
              
              
            </form>
             <form name="main" method="post" action="thankyou.php">
                <input type="submit" class="donebuttonbal" />
