...
<div id="atm">
	<div id="atmbody">
    <div id="screen">
    	<p id= "top" align="center"> Thank you for using <br/> Akhtar Bank</p>
        <p id="display"></p>
        
        <div id="arrow"> <p> Remove Card </p><img src="images/arrow.gif" height="140px" class="arrow_gif" /> </div>
    </div>
    <div id="slots">
    	<div id="cash">
        ...
        <div id="card">
        <img name= 'card' src="images/leavingcard.gif" onClick="changeimg('card', 'blackcard'); document.getElementById('arrow').innerHTML = '';"; alt="Card Slot" class="card"/>
        </div>
    </div>
    </div>
