...
<div id="atm">
	<div id="atmbody">
    <div id="screen">
    	<p id= "top" class="AmountMess">Select the amount you want to withdraw:</p>
        <div id="leftwithdraw">
        		<form name="main" method="post" action="take.php">
        		<table cellpadding="10px">
        		<tr>
                <td><input type="submit" class="withdraw10"  name="amount" value="10"/></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                ...
                <td><input type="submit" class="withdraw80"  name="amount" value="80"/></td>
                </tr>
                
        		<tr>
                <td><input type="submit" class="withdraw20"  name="amount" value="20"/></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                ...
                <td><input type="submit" class="withdraw100"  name="amount" value="100"/></td>
                </tr>
                
        		<tr>
                <td><input type="submit" class="withdraw40"  name="amount" value="40"/></td>
                <td></td>
                <td></td>
                <td></td>
                <td>
                <input type="button" class="backbutton" onClick="document.location.href='pinnumber.php'" />
               </td>
                <td></td>
                <td></td>
                <td></td>
                <td><input type="submit" class="withdraw200"  name="amount" value="200"/></td>
                </tr>
                
                <tr>
                <td><input type="submit" class="withdraw60"  name="amount" value="60"/></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                ...
                <td><input type="submit" class="withdraw300"  name="amount" value="300"/></td>
