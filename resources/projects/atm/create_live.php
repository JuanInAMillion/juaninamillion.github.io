  ...
  //session_destroy();
	...
	mysql_query("DROP TABLE Customer;") or die(mysql_error());
	mysql_query("DROP TABLE Account;") or die(mysql_error());
	mysql_query("DROP TABLE Transaction;") or die(mysql_error());
	mysql_query("DROP TABLE ATM;") or die(mysql_error());
